  ...
  <header>
    ...
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          <!-- logo -->
          <a class="brand logo" href="<?php echo site_url('EditorCtl') ?>"><img src="<?php echo base_url()."assets/img/logo.png"?>" alt=""></a>
          <!-- end logo -->
          <!-- top menu -->
            ...
            <nav>
              <ul class="nav topnav">
                <li class="dropdown active">
                  <a href="<?php echo site_url('EditorCtl') ?>">Home</a>
                </li>
                <li class="dropdown">
                  <a href="#">Task</a>
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <?php if (sizeof($roles)==2) { ?>
                      <li><a href="<?php echo base_url()."accountctl/changerole"?>" class="confirmation">Switch to Reviewer</a></li>
                    <?php }?>
...
<script type="text/javascript">
    ...
    var confirmIt = function (e) {
        if (!confirm('Are you sure want to switch to Reviewer?')) e.preventDefault();
    };
