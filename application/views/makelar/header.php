  ...
  <header>
    ...
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          <!-- logo -->
          <a class="brand logo" href="<?php echo site_url('MakelarCtl') ?>"><img src="<?php echo base_url()."assets/img/logo.png"?>" alt=""></a>
          <!-- end logo -->
          <!-- top menu -->
            ...
            <nav>
              <ul class="nav topnav">
                <li class="dropdown active">
                  <a href="<?php echo site_url('MakelarCtl') ?>">Home</a>
                </li>
                <li class="dropdown">
                  <a href="#">Task</a>
                  <ul class="dropdown-menu">
                    ...
                    <li><a href="<?php echo base_url()."makelarCtl/viewPaidTask"?>">View Paid Task</a></li>
                  </ul>
                </li>
                <li class="dropdown">
